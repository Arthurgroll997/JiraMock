...
class CyberArkConnector extends BaseConnector {
  ...
  _defineActions() {
    ...
    this.defineAction('safes.remove-member', {
      method: 'DELETE',
      path: '/api/Safes/{safeUrlId}/Members/{memberName}',
    ...
    this.defineAction('accounts.reconcile-password', {
      method: 'POST',
      path: '/api/Accounts/{id}/Reconcile',
    ...
    this.defineAction('platforms.activate', {
      method: 'POST',
      path: '/api/Platforms/{platformId}/Activate',
      description: 'Plattform aktivieren',
    });
    this.defineAction('platforms.deactivate', {
      method: 'POST',
      path: '/api/Platforms/{platformId}/Deactivate',
    ...
    this.defineAction('sessions.get', {
      method: 'GET',
      path: '/api/LiveSessions/{sessionId}',
    ...
    this.defineAction('health.component', {
      method: 'GET',
      path: '/api/ComponentsMonitoringDetails/{componentId}',
