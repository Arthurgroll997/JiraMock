...
function userDN(cn, ou) {
  return `CN=${cn},${ou},${baseDN}`;
}
function groupDN(cn, ou) {
  return `CN=${cn},${ou},${baseDN}`;
}
function ouDN(path) {
  return `${path},${baseDN}`;
...
const ous = [
  ...
  {
    distinguishedName: `OU=IT Department,OU=Users,${baseDN}`,
    name: 'IT Department',
    description: 'IT staff',
  },
  {
    distinguishedName: `OU=Finance,OU=Users,${baseDN}`,
    name: 'Finance',
    description: 'Finance department',
  },
  {
    distinguishedName: `OU=Engineering,OU=Users,${baseDN}`,
    name: 'Engineering',
    description: 'Engineering department',
  },
  {
    distinguishedName: `OU=Management,OU=Users,${baseDN}`,
    name: 'Management',
    description: 'Management',
  },
  {
    distinguishedName: `OU=Service Accounts,${baseDN}`,
    name: 'Service Accounts',
    description: 'Service accounts',
  },
  {
    distinguishedName: `OU=Security Groups,${baseDN}`,
    name: 'Security Groups',
    description: 'Security groups',
  },
  {
    distinguishedName: `OU=Server Access,OU=Security Groups,${baseDN}`,
    name: 'Server Access',
    description: 'Server access groups',
  },
  {
    distinguishedName: `OU=Application Access,OU=Security Groups,${baseDN}`,
    name: 'Application Access',
    description: 'Application access groups',
  },
  {
    distinguishedName: `OU=Servers,${baseDN}`,
    name: 'Servers',
    description: 'Server computer objects',
  },
  {
    distinguishedName: `OU=Workstations,${baseDN}`,
    name: 'Workstations',
...
const userDefs = [
  {
    ...
    ou: `OU=IT Department,OU=Users`,
    enabled: true,
    memberOf: [grpRdpAdmins, grpVpn, grpItAdmins],
  },
  {
    sam: 'j.doe',
    cn: 'John Doe',
    ...
    enabled: true,
    manager: 'c.jones',
    memberOf: [grpDbOps, grpErp, grpVpn],
  },
  {
    sam: 'a.smith',
    cn: 'Alice Smith',
    ...
    ou: `OU=Finance,OU=Users`,
    enabled: true,
    manager: 'c.jones',
    memberOf: [grpDbOps, grpVpn],
  },
  {
    sam: 'b.wilson',
    cn: 'Bob Wilson',
  ...
  },
  {
    ...
    dept: 'Management',
    title: 'CTO',
    ou: `OU=Management,OU=Users`,
    enabled: true,
    memberOf: [grpErp, grpVpn],
  },
  {
    sam: 'svc-integration',
    cn: 'Service Integration',
    gn: 'Service',
    sn: 'Integration',
    dept: 'IT Department',
    ...
    enabled: true,
    memberOf: [grpSvcInt, grpItAdmins],
  },
  {
    sam: 'svc-fudo-sync',
    cn: 'Fudo Sync Service',
    gn: 'Fudo',
    sn: 'Sync',
    dept: 'IT Department',
    title: 'Service Account',
...
const groupDefs = [
  {
    name: 'GRP-RDP-Admins',
    ou: 'OU=Server Access,OU=Security Groups',
    desc: 'Remote Desktop administrators for servers',
    scope: 'global',
    members: ['admin', 'b.wilson'],
  },
  {
    name: 'GRP-DB-Operators',
    ou: 'OU=Server Access,OU=Security Groups',
    desc: 'Database operations team',
    scope: 'global',
    members: ['j.doe', 'a.smith'],
  },
  {
    name: 'GRP-SVC-Integration',
    ou: 'OU=Application Access,OU=Security Groups',
    desc: 'Integration service accounts',
    scope: 'global',
    members: ['svc-integration'],
  },
  {
    name: 'GRP-ERP-Users',
    ou: 'OU=Application Access,OU=Security Groups',
    desc: 'ERP application users',
    scope: 'global',
    members: ['j.doe', 'c.jones'],
  },
  {
    name: 'GRP-VPN-Users',
    ou: 'OU=Application Access,OU=Security Groups',
    desc: 'VPN access users',
    scope: 'global',
    members: ['admin', 'j.doe', 'a.smith', 'b.wilson', 'c.jones', 't.developer', 'l.leaving'],
  },
  {
    name: 'GRP-IT-Admins',
    ou: 'OU=Server Access,OU=Security Groups',
    desc: 'IT administrators',
    scope: 'global',
    members: ['admin', 'b.wilson', 'svc-integration'],
  },
];

const groups = groupDefs.map((g) => {
  const memberDNs = g.members
    .map((sam) => {
